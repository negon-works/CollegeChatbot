...
DEFAULT_BOT_ENTRIES = [
    ...
    ("college", "about_college", "tell me about the college, about college of engineering aranmula, what is this college, college information, college details",
     "College of Engineering Aranmula is an engineering institution located in Aranmula, Pathanamthitta district in Kerala. The college is managed by the Co-operative Academy of Professional Education (CAPE), which operates under the Government of Kerala. The college provides engineering and technical education to build strong practical and technical skills.",
     "Would you like to explore courses, campus facilities, or student life?", 21),
    ("college", "course_details_cs", "computer science, cse, cs course",
     "Computer Science Engineering focuses on programming, software development, algorithms, and computer systems. Students learn coding, software design, and modern computing technologies.",
     "", 22),
    ("college", "course_details_civil", "civil engineering, civil course",
     "Civil Engineering focuses on designing and building infrastructure such as roads, bridges, buildings, and water systems. Students learn structural design, construction methods, and environmental engineering.",
     "", 23),
    ("college", "course_details", "course details, tell me about course",
     "I can share details for specific courses. For example, you can ask about Computer Science or Civil Engineering.",
     "", 24),
    ("college", "course_difficulty", "is computer science hard, is civil engineering tough, which course is difficult, hard, tough, difficult",
     "Every course has its own challenges. Computer Science may require strong problem-solving skills and programming practice, while Civil Engineering involves mathematics, physics, and structural design. Choosing a course that matches your interests usually makes learning easier.",
     "", 25),
    ...
    ("college", "hostel_food", "hostel food, mess food, food in hostel",
     "Hostel students usually receive breakfast, lunch, and dinner. Meals often include Kerala-style dishes like rice, curry, vegetables, and other simple balanced options.",
     "", 51),
    ("college", "campus_environment", "campus environment, how is the campus, is campus good",
     "The campus environment is generally calm and suitable for studying. Students also participate in events, sports, and technical activities.",
     "", 52),
    ("college", "campus_facilities", "facilities, library, labs, canteen available",
     "The campus offers a library, computer labs, engineering laboratories, a canteen, sports facilities, and spaces for events and student activities.",
     "", 53),
    ("college", "canteen_food", "canteen, snacks",
     "Yes, there is a canteen on campus with snacks, tea, coffee, and simple meals. Many students use it during breaks.",
     "", 54),
    ("college", "student_life", "student life, college life, events",
     "Student life includes academics, cultural events, sports, and technical programs. These help students build skills and enjoy college life.",
     "", 55),
    ("college", "placement", "placement, job opportunities, companies visiting",
     "The college has a placement cell that helps students prepare for jobs and connect with recruiters through training and recruitment activities.",
     "", 56),
    ("college", "location", "where is the college, how to reach, college location, location",
     "The college is located in Aranmula, Pathanamthitta district, Kerala. Students and visitors usually reach the campus using buses and local transport from nearby towns.",
     "", 57),
    ("college", "visit_campus", "visit campus, parents visit, see the college",
     "Visitors can usually visit the campus during working hours. It is better to call the college office beforehand for a smooth visit.",
     "", 58),
